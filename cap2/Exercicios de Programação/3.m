...
%     Operação para rotação;
    resultado = rotacional*referencia+translacao;
    
    
    clc;
    disp('--------MATRIZ--------');
    disp(referencia);
    disp('--------MATRIZ TRASLAÇÃO--------');
    disp(translacao);
    disp('--------MATRIZ ROTACIONAL--------');
    disp(rotacional);
...
% Teste realizado para encontrar a rotação em Z;
